...
def parse_args():
    ...
    parser.add_argument(
        'config',
        nargs='?',
        default='/opt/project/datasets/mmocr/configs/textdet/dbnetpp/dbnet_custom.py',
        help='Train config file path')
    parser.add_argument('--work-dir',default='/opt/project/datasets/mmocr/work_dirs/dbnet_custom', nargs='?', help='The dir to save logs and models')
    parser.add_argument(
